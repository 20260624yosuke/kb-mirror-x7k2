...
- 説明HTML `wiki/_attachments/project-hub-index/20260903-helen-h0157-resume-status.html` の文言が導入完了前で止まっている（リード文とフッターの2件、表の「正規導入 完了」と不整合）。完了版へ更新するか、そのまま区切るかは未決（2026-09-03カードで確認する）。
