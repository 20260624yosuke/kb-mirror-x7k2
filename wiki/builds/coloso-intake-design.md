...
| `2024:04:24_晃田ヒカ` | `2024_04_24_晃田ヒカ` | 22 | 講師名正綴「晃田ヒカ」凍結済み。**音声(m4a)22本は除外**(下の例外注記) |
...
- **例外(2026-08-25 武田さん承認)**: 晃田ヒカのみ動画(mp4)22本を対象とし、同名ペアの音声(m4a)22本は除外する。各番号フォルダのmp4(画面録画)とm4aは再生時間ほぼ同一(実測: 01=314.9秒 vs 312.3秒、10=1433.6秒 vs 1429.5秒、22=1932.7秒 vs 1929.9秒)=内容重複の可能性大(中身は未確認)。ツール側は対象表の `media_exts` フィールドで対応し、mapping.json に `media_exts_included` を記録する。
